...
const SearchComponent = forwardRef<HTMLInputElement, SearchComponentProps>(
  ({ handleSearch, className }: SearchComponentProps, searchRef: React.ForwardedRef<HTMLInputElement>) => {
    const [ searchText, setSearchText ] = useState<string>("");

    const updateSearchText = (evt: React.ChangeEvent<HTMLInputElement>) => {
